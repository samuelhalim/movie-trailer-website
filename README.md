...
# About
A program written in python to generate HTML for a website that shows movies with their corresponding movie posters. By clicking at the movie posters, trailer of the corresponding movie will be played._
...
# How to run
You can either download the ZIP file or clone this repository to your local.__

Open the text-based interface for your operating system (e.g. the terminal window in Linux, the command prompt in Windows).__

Navigate to the project directory and type in the following command:_
`python entertainment_center.py`_
